...
2. Place a copy of ps2ip141.h (Found within the include folder in this package) into the folder containing the compiler header files for the IOP (E.g. ps2sdk/ee/include).
