...
#else
float hyp2f1f(aa, bb, cc, xx) double aa, bb, cc, xx;
#endif
{
	float a, b, c, x;
	float d, d1, d2, e;
...
#else
static float hyt2f1f(aa, bb, cc, xx, loss) double aa, bb, cc, xx;
float *loss;
#endif
{
	float a, b, c, x;
...
#else
static float hys2f1f(aa, bb, cc, xx, loss) double aa, bb, cc, xx;
float *loss;
#endif
{
	int i;
