...
#else
int polclrf(a, n) register float *a;
int n;
#endif
{
    int i;
...
#else
int polmovf(a, na, b) register float *a, *b;
int na;
#endif
{
    int i;
...
#else
int polmulf(a, na, b, nb, c) float a[], b[], c[];
int na, nb;
#endif
{
    int i, j, k, nc;
...
#else
int poladdf(a, na, b, nb, c) float a[], b[], c[];
int na, nb;
#endif
{
    int i, n;
...
#else
int polsubf(a, na, b, nb, c) float a[], b[], c[];
int na, nb;
#endif
{
    int i, n;
...
#else
int poldivf(a, na, b, nb, c) float a[], b[], c[];
int na, nb;
#endif
{
    float quot;
...
#else
int polsbt(a, na, b, nb, c) float a[], b[], c[];
int na, nb;
#endif
{
    int i, j, k, n2;
