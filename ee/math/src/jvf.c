...
#else
static float recurf(n, xx, newn) float *n;
double xx;
float *newn;
#endif
{
...
#else
static float jvsf(nn, xx) double nn, xx;
#endif
{
...
#else
static float hankelf(nn, xx) double nn, xx;
#endif
{
...
#else
static float jnxf(nn, xx) double nn, xx;
#endif
{
...
#else
static float jntf(nn, xx) double nn, xx;
#endif
{
    float n, x, z, zz, z3;
    float cbn, n23, cbtwo;
