...
#else
float hypergf(aa, bb, xx) double aa, bb, xx;
#endif
{
...
#else
static float hy1f1pf(aa, bb, xx, err) double aa, bb, xx;
float *err;
#endif
{
...
#else
static float hy1f1af(aa, bb, xx, err) double aa, bb, xx;
float *err;
#endif
{
...
#else
float hyp2f0f(aa, bb, xx, type, err) double aa, bb, xx;
