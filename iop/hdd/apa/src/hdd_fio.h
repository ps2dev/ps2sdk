...
int hddIoctl2(iop_file_t *f, long request, void *argp, long arglen, void *bufp, long buflen);
...
int hddDevctl(iop_file_t *f, char *devname, int cmd, void *arg, int arglen, void *bufp, long buflen);

int fioUnsupported(void);
