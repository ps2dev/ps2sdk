...
extern unsigned int sceSifGetSreg(int index);
extern void sceSifSetSreg(int index, unsigned int value);
extern void sceSifSetCmdBuffer(SifCmdHandlerData_t *cmdBuffer, int size);
extern void sceSifSetSysCmdBuffer(SifCmdSysHandlerData_t *sysCmdBuffer, int size);
...
extern unsigned int sceSifSendCmd(int cmd, void *packet, int packet_size, void *src_extra,
    void *dest_extra, int size_extra);
extern unsigned int isceSifSendCmd(int cmd, void *packet, int packet_size, void *src_extra,
    void *dest_extra, int size_extra);

extern void sceSifInitRpc(int mode);
extern int sceSifBindRpc(SifRpcClientData_t * client, int rpc_number, int mode);
extern int sceSifCallRpc(SifRpcClientData_t * client, int rpc_number, int mode, void *send,
...
extern SifRpcDataQueue_t * sceSifSetRpcQueue(SifRpcDataQueue_t *q, int thread_id);
extern SifRpcServerData_t *sceSifGetNextRequest(SifRpcDataQueue_t * qd);
extern void sceSifExecRequest(SifRpcServerData_t * srv);
...
extern unsigned int sceSifSendCmdIntr(int cmd, void *packet, int packet_size, void *src_extra,
    void *dest_extra, int size_extra, void (*completioncb)(void *userdata), void *userdata);
extern unsigned int isceSifSendCmdIntr(int cmd, void *packet, int packet_size, void *src_extra,
    void *dest_extra, int size_extra, void (*completioncb)(void *userdata), void *userdata);
