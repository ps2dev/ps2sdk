...
struct SMBTransactionRequest_t
{ //size = 28
	u16 TotalParamCount;
	u16 TotalDataCount;
	u16 MaxParamCount;
...
struct SMBTransactionResponse_t
{ //size = 20
	u16 TotalParamCount;
	u16 TotalDataCount;
	u16 Reserved;
...
struct WriteAndXRequest_t smb_Write_Request = {
    ...
    0,
    0x3f,
    0 // 0x01 is WriteThrough mode and 0x3f is DataOffset
};
