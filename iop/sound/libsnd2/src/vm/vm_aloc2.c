...
void _SsVmDoAllocate(void)
{
	...
	_svm_sreg_buf2[_svm_cur.m_voice_idx].m_vag_spu_addr = ( (_svm_cur.m_vag_idx2 & 1) != 0 ) ? _svm_pg[(_svm_cur.m_vag_idx2 - 1) / 2].m_vag_spu_addr_hi : _svm_pg[(_svm_cur.m_vag_idx2 - 1) / 2].m_vag_spu_addr_lo;
