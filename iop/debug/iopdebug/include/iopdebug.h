...
#define I_iop_dbg_get_dcic DECLARE_IMPORT(9, iop_dbg_get_dcic)

void iop_dbg_set_dcic(u32 v);
#define I_iop_dbg_set_dcic DECLARE_IMPORT(10, iop_dbg_set_dcic)



u32 iop_dbg_get_bpc(void);
#define I_iop_dbg_get_bpc DECLARE_IMPORT(11, iop_dbg_get_bpc)

void iop_dbg_set_bpc(u32 v);
#define I_iop_dbg_set_bpc DECLARE_IMPORT(12, iop_dbg_set_bpc)



u32 iop_dbg_get_bpcm(void);
#define I_iop_dbg_get_bpcm DECLARE_IMPORT(13, iop_dbg_get_bpcm)

void iop_dbg_set_bpcm(u32 v);
#define I_iop_dbg_set_bpcm DECLARE_IMPORT(14, iop_dbg_set_bpcm)



u32 iop_dbg_get_bda(void);
#define I_iop_dbg_bda DECLARE_IMPORT(15, iop_dbg_bda)

void iop_dbg_set_bda(u32 v);
#define I_iop_dbg_set_bda DECLARE_IMPORT(16, iop_dbg_set_bda)

u32 iop_dbg_get_bdam(void);
#define I_iop_dbg_bdam DECLARE_IMPORT(17, iop_dbg_bdam)

void iop_dbg_set_bdam(u32 v);
#define I_iop_dbg_set_bdam DECLARE_IMPORT(18, iop_dbg_bdam)


void iop_dbg_set_bpr(u32 addr, u32 mask, u32 user_mask);
#define I_iop_dbg_set_bpr DECLARE_IMPORT(19, iop_dbg_set_bpr)

void iop_dbg_set_bpw(u32 addr, u32 mask, u32 user_mask);
#define I_iop_dbg_set_bpw DECLARE_IMPORT(20, iop_dbg_set_bpw)

void iop_dbg_set_bpx(u32 addr, u32 mask, u32 user_mask);
#define I_iop_dbg_set_bpx DECLARE_IMPORT(21, iop_dbg_bpx)


void iop_dbg_clr_bps(void);
#define I_iop_dbg_clr_bps DECLARE_IMPORT(22, iop_dbg_clr_bps)

void iop_dbg_clr_bpda(void);
#define I_iop_dbg_clr_bpda DECLARE_IMPORT(23, iop_dbg_clr_bpda)

void iop_dbg_clr_bpx(void);
#define I_iop_dbg_clr_bpx DECLARE_IMPORT(24, iop_dbg_clr_bpx)
